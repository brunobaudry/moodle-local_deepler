...
class glossary_renderer extends plugin_renderer_base {
    ...
    public function glossary_uploader(string $form): string {
        $data = [
                ...
                'sesskey' => sesskey(),
                'glossaryexplcol1' => format_text(get_string('glossary:upload:helpmodal:intro', 'local_deepler'), FORMAT_MARKDOWN,
                        ['trusted' => true]),
                'glossaryexplcol2' => format_text(get_string('glossary:upload:helpmodal:col1', 'local_deepler'), FORMAT_MARKDOWN,
                        ['trusted' => true]),
                'glossaryexplcol3' => format_text(get_string('glossary:upload:helpmodal:col2', 'local_deepler'), FORMAT_MARKDOWN,
                        ['trusted' => true]),
                ...
                'glossaryhelpmodaltitle' => get_string('glossary:upload:helpmodal:title', 'local_deepler'),
                'close' => get_string('ok'),
